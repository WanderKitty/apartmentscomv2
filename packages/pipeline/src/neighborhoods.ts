...
// polygons fetched via Nominatim (© OpenStreetMap contributors, ODbL) —
// "Downtown Orlando" is OSM's Central Business District, "Lake Nona" is
// Lake Nona South. Mills 50 has no OSM polygon and carries a generous
// hand-drawn box around Mills Ave × Colonial Dr.
